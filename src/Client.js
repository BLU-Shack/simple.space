...
const { Bot, Emoji, Guild, UpvoteContents, User, FetchError, Stats, Store } = require('./structures/Classes.js').Classes;
const { ClientOptions, FetchOptions, PostOptions, UpvoteFetchOptions } = require('./options/');
